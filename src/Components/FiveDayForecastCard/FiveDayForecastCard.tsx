...
export const FiveDayForecastCard: FC<FiveDayForecastCardProps> = ({
  key,
  temp,
  days,
}) => {
      ...
      <>
        ...
        <section className="all-days">
          <section className="day-two">
            ...
            <img
              className="day-two-icon"
              src={`http://openweathermap.org/img/wn/${days.daily[1].weather[0].icon}@2x.png`}
              alt="Weather Icon"
            ></img>
          ...
          <section className="day-three">
            ...
            <img
              className="day-three-icon"
              src={`http://openweathermap.org/img/wn/${days.daily[2].weather[0].icon}@2x.png`}
              alt="Weather Icon"
            ></img>
          ...
          <section className="day-four">
            ...
            <img
              className="day-four-icon"
              src={`http://openweathermap.org/img/wn/${days.daily[3].weather[0].icon}@2x.png`}
              alt="Weather Icon"
            ></img>
          ...
          <section className="day-five">
            ...
            <img
              className="day-five-icon"
              src={`http://openweathermap.org/img/wn/${days.daily[4].weather[0].icon}@2x.png`}
              alt="Weather Icon"
            ></img>
